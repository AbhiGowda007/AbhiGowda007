...
#include <memory>
#include "../../Plugins_Read/File_Reader.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_File_Reader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_File_Reader_t qt_meta_stringdata_File_Reader = {
    {
QT_MOC_LITERAL(0, 0, 11) // "File_Reader"
...
QT_INIT_METAOBJECT const QMetaObject File_Reader::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_File_Reader.data,
...
void *File_Reader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Plugins_Read"))
        return static_cast< Plugins_Read*>(this);
...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    '0', 
    // "className"
    0x03,  0x6b,  'F',  'i',  'l',  'e',  '_',  'R', 
    'e',  'a',  'd',  'e',  'r', 
    0xff, 
};
QT_MOC_EXPORT_PLUGIN(File_Reader, File_Reader)
